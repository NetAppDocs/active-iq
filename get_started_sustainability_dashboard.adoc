...
[.lead]
BlueXP sustainability dashboard provides AIOps-enabled reporting and scoring with actionable insights to improve your sustainability posture. You can use NetApp BlueXP or Digital Advisor to log in to the sustainability dashboard.
