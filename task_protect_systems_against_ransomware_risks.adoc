...
. Select the *Unique Risks* tab and select the link in the *Corrective Action* column.
. Select the *Affected Systems* tab to view systems with risks.
. Select the remediation actions that are recommended to protect the systems.
