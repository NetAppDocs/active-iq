...
* View data reduction ratio, the logical space used, the physical space used, and the total data saved.
...
* link:concept_value_insights.html[Discover Value Insights], which provides overall health, savings, stability, and security information for your ONTAP system.
