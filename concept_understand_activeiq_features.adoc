...
[.lead]
The Active IQ Digital Advisor displays information about the overall status of your storage system. It displays high-level information about wellness of the system, inventory, planning, upgrades, and valuable insights at a watchlist level.
