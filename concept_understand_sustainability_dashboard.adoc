...
== Cost
NetApp does not charge you for using the BlueXP sustainability service. You can utilize it with your active support contract.

== Licensing
No special license is required to access this service. You can utilize it with your active support contract if you have enabled AutoSupport for your systems.
