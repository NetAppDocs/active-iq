...
= Improve your storage system sustainability score from Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
image:recommended_actions.png[A screenshot that shows the list of actions in the expanded view.]
  ...
  ** If you select *Later*, it moves the selected recommended action to the *Actions for later* tab. The selected action will be postponed for 30 days. After 30 days, this action will move to the *Recommended actions* tab. 
   ** You can also review the postponed actions anytime and can select *Consider* to move them to the *Recommended actions* tab.
  +
...
. Select the number of actions from the *Recommended actions* column for the target cluster.
+
