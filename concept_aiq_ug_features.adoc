...
In the *Cluster Dashboard*, summary of total number volumes that are not tagged are shown. image:image30.png[image,width=20,height=18]
...
image:image31.png[image,width=28,height=18]
