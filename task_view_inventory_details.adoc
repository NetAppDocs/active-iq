...
== View system details
.Steps
. In the *Inventory* widget, select *Systems* to view the system information of all platforms or select the platform type and then select *Systems* to view systems specific to that platform.
. Select the node or cluster to view detailed information about the system.
. Select *Download* to download the *Inventory* report to view the system details in .xls format.
. Select *Download* to download the *Ansible Inventory* report to view the system details in the .yml and .ini formats at the region or site level.
+
...
.Steps
. In the *Inventory* widget, select *Support Entitled Switches* to view information about all the support entitled switches.