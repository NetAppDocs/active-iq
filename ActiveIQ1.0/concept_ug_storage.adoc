...
Storage dashboard shows the storage efficiency ratio, capacity, and savings for entire storage systems running ONTAP 9.1 and later. Efficiency ratio and savings can be seen with and without Snapshots for AFF systems, non-AFF systems, or both.
