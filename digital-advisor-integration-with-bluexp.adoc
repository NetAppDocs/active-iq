...
Starting in November 2022, Digital Advisor users will be encouraged to use Digital Advisor in BlueXP. When you log in to Digital Advisor, you'll see a notification recommending you to access Digital Advisor in BlueXP.
