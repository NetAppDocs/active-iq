...
More details about ratios are in <<Appendix>> at the end of this document.
...
. Calculate ‘Data Reduction Logical Used’ and ‘Data Reduction Physical Used’ for all the aggregates in the node/cluster using the formula mentioned in <<AFF_SE_calculator#Aggregate Data Reduction Ratio,Aggregate Data Reduction Ratio>> section.
