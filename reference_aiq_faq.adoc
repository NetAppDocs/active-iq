...
The Digital Advisor Efficiency Dashboard calculates the efficiency ratio at multiple levels, including customer, site, group, cluster, and node. If you turn on the *With Snapshots copies* toggle, the efficiency ratio calculation includes the following storage efficiency technologies:
...
By default, the efficiency ratio calculation does not include Snapshots storage efficiency technology.
...
*Which AutoSupport instances are used for calculating data reduction ratios?*
...
The following objects are not considered while calculating data reduction ratios:
...
*How can I see the trend in data reduction ratios?*

Currently, data reduction ratios are calculated based on the latest weekly or user-triggered AutoSupport instance. Efficiency trending may be considered for a future release.
...
*Why does adding all individual efficiency savings not add up to data reduction savings?*
