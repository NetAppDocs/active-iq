...
You may not be able to view certain systems in the inventory page due to one of following reasons:

* New systems take over a day to reflect in Active IQ. If you are unable to view the systems after a day, create a nontechnical case. <<Nontechnical case,Learn more about creating a nontechncial case.>>
* You are not authorized to view the systems.
