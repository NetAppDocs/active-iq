...
----
For more information on the command, refer to link:https://docs.netapp.com/ontap-9/topic/com.netapp.doc.dot-cm-cmpr-910/storage__disk__show.html[storage disk show].
