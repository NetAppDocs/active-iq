...
----
For more information on the command, refer to link:link-with-underscores:https://docs.netapp.com/ontap-9/index.jsp?topic=%2Fcom.netapp.doc.dot-cm-cmpr-910%2Fstorage__disk__show.html[storage disk show].
