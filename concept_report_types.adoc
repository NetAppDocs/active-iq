...
= Learn about Digital Advisor reports
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
| Provides information about various Digital Advisor KPIs in a PowerPoint (PPT) format, with different KPI being described on different slides.
| Yes
| Yes
| No
| Inventory
...
| No
| Security
| Provides a comprehensive, exportable overview of ONTAP storage security risks and compliance gaps across clusters, SVMs, and volumes.
| Yes
| No
| No
...
// 29-JULY-2026 updated product name from Active IQ to Digital Advisor
