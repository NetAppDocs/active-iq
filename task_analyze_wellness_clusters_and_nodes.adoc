...
. At the cluster or node level, select *ClusterViewer* next to the *Configuration* widget.
. Select the *Visualization* tab to view a graphical representation of the cluster.
