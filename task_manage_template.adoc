...
= Manage config drift templates in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
.Steps
. From the left pane, select *Config Drift*.
. Select image:clone_icon.png[clone] to make a copy of the template.
. Select image:share_icon.png[share] and enter the usernames with whom you want to share the template.
+
NOTE: If you enter the email address of the user instead of the username, the template will not be shared.

. Select image:edit_icon.png[edit] to update the details of the template.
. Select image:delete_icon.png[delete] to delete the template.
