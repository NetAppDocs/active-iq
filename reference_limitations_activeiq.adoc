...
= Known limitations in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
On the AutoSupport Reporting page, selecting on any of the statuses, systems that recently stopped sending, or systems that have AutoSupport turned off does not navigate to the Health Check screen. 
...
// 22-JULY-2026 removed references to data ONTAP/7-mode 