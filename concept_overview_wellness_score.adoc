...
[.lead]
Wellness score provides detailed information about your storage system. It provides information about different attributes of your storage system such as performance and efficiency, capacity, configuration settings, security, and others. Wellness scores proactively provides information about software and hardware that have expired or are near expiration in the next 6 months.
