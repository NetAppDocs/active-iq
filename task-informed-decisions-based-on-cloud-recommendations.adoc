...
= Analyze your storage system health with cloud recommendations in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
NOTE: Digital Advisor navigates you to NetApp Console to implement the recommendations.
...
The volumes that meet the following criteria are recommended for migration to Cloud Volumes ONTAP (CVO):
...
.Steps
. From the left pane, select *Cloud Recommendations*.
. Select any one link in the *Migration* pane.
. Select *Migrate to Cloud* to launch the *Console*.
...
.Steps
. From the left pane, select *Cloud Recommendations*.
. Select on any one link in the *Tiering* pane.
. Select *Tier Data* to launch the *Console*.
...
.Steps
. From the left pane, select *Cloud Recommendations*.
. Select on any one link in the *Backup & Archive* pane.
. Select *Backup to Cloud* to launch the *Console*.
...
.Steps
. From the left pane, select *Cloud Recommendations*.
. Select any one link in the *Disaster Recovery* pane.
. Select *Replicate to Cloud* to launch the *Console*.
