...
. Click *Migrate to Cloud* to launch the *Console*.
...
. Click *Tier Data* to launch the *Console*.

To learn more about FabricPool, refer to link:https://www.netapp.com/pdf.html?item=/media/17239-tr4598.pdf[FabricPool Best Practices^].
...
. Click *Backup to Cloud* to launch the *Console*.
...
. Click *Replicate to Cloud* to launch the *Console*.
