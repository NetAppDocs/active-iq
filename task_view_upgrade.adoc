...
. Click *Submit*.
. Go to *Reports*. You can monitor the status of the upgrade plan report and download it once it is available.
+
You will also receive an email containing the upgrade plan report once it is generated.
+
