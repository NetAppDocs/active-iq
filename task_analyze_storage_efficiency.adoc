...
summary: View capacity details and storage efficiency savings for your storage system.
---

= View capacity and storage efficiency savings in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
.. Select *Add Capacity* to send a notification to NetApp or your partner to add capacity.
. View the storage efficiency and the data savings of your storage system.
.. If the storage efficiency ratio of your storage system is higher than the average storage efficiency ratio, select *Share Your Success Story* to let us know the best practices followed.
.. If the storage efficiency ratio of your storage system is less than the average storage efficiency ratio, select *Contact Us* to let us know the configurations of your storage system.
...
// 29-JULY-2026 updated snapshot capitalization to meet current standards, also removed ONTAP 9.10 and earlier references
// 29-JULY-2026 fix frontmatter keywords and summary
