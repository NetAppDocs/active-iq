...
.Steps
. Select the *Wellness*  widget on the dashboard or select *View All Actions* to view the list of all the actions and risks.
...
. Select the risk name to view information about the risk.
. Select the associated corrective actions and follow the information to resolve the risk.
