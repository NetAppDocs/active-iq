...
= View firmware update recommendations in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
.Steps
. On the dashboard page, select *Other recommendations* in the *Upgrade Advisor* widget.
. Select *View recommendations* to view the list of recommendations.
. In the *Update Status* column, select *See progress* to view the clusters that are eligible for an update.
. In case of any issues, select the respective links to view the steps to mitigate the issues.
