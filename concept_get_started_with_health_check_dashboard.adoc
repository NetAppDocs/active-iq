...
= Get started with Digital Advisor Health Check dashboard
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
To view your health check score and information about the systems in your install base, select the *AutoSupport Adoption* widget.
+
...
To view detailed information about support contracts, select the *Support & Entitlements* widget. You can also renew your support contracts using this widget.
+
