...
.Steps
. In the *Planning* widget, click *Storage Expansion*.
+
...
. Click *Send* to send the request to the NetApp storage team to assist with the storage expansion for the selected systems.
