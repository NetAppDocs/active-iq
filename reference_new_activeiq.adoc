...
* You can access the Upgrade Advisor page for your default watchlist or dashboard using the link:https://activeiq.netapp.com/redirect/upgrade-advisor[Upgrade Advisor^] link. 
