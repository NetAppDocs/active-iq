...
=== Inventory
VMware assets information on vCenters, ESXi hosts, and Virtual Machines are now included in Inventory details, to provide full stack inventory and interoperability checks.
