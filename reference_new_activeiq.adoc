...
* *Planning widget:*
** *Capacity Addition:* For any GRID sites that are exceeding the threshold of 70% of existing capacity, you’ll be notified. You have the option to add capacity for the Storage Grids in the site, for the next 1, 3, & 6months if the capacity threshold is likely to exceed 70%.
...
* *GRID Viewer:* From the *Configuration* widget, you can view the GRID configuration in detail by clicking the *GRID Viewer* link.
...
* *GRID Viewer (Configuration Details) as Download:* You can download the site details and capacity details for the selected StorageGRID by clicking the *Download* button in the Grid Viewer screen.
