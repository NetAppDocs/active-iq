...
You can now access the Sustainability metrics for default dashboards and watchlists by using the link:https://activeiq.netapp.com/redirect/sustainability[Sustainability Dashboard^] link.

=== ClusterViewer
Disk RPM information is now available on the Disk Summary page.
