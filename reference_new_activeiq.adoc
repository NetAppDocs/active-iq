...
=== Wellness Risks
You can now view controllers that have "Critical Risks" impact related to security vulnerabilities that are flagged based on Common Vulnerability Scoring system (CVSS) score.
