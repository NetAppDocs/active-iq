...
You can view average read, write, and other operations in performance charts at a volume level.

=== Storage Efficiency

Storage efficiency is available, at a node level, for ONTAP systems including AFF A-Series, AFF C190, All SAN Array, and FAS500 running ONTAP 9.10 and later.
...
link:https://play.google.com/store/apps/details?id=com.netapp.aiqda&hl=en_IN&gl=US[Digital Advisor Mobile Application (Android)]
