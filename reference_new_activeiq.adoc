...
* The toggle *Savings without Snapshot Backups* is renamed to *With Snapshot copies* along with a change to its functionality. link:reference_aiq_faq.html[Learn more].
