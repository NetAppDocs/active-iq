...
You can now access the Sustainability metrics for default dashboards and watchlists directly by using the link:https://activeiq.netapp.com/redirect/sustainability[Sustainability Dashboard^] link.
