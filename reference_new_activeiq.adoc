...
=== Watchlist
When you access Active IQ Digital Advisor for the first time, you should now create a watchlist instead of a dashboard. You can also view the dashboard for different watchlists, edit the details of an existing watchlist, share a watchlist, and delete a watchlist.
