...
The inventory widget has been enhanced to improve the user experience, by providing user friendly date formats, additional columns or end of platform support and end of version support.
