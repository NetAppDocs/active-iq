...
Active IQ is being renamed to Digital Advisor and is being integrated into a unified management platform, BlueXP. link:digital-advisor-integration-with-bluexp.html[Learn more].
...
=== BlueXP
BlueXP users can now open Active IQ links in new tabs, wherever applicable, similar to the existing functionality in Active IQ.
