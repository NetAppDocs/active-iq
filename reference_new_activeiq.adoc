...
=== AFF/FAS firmware using Ansible Playbook
The documentation has been enhanced to include information about downloading, installing, and executing the FAS/AFF firmware ansible automation package.
...
=== AFF/FAS firmware
The update AFF/FAS firmware screen has been enhanced to provide a better user experience.
