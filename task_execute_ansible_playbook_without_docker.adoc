...
----
For more information about the ansible-galaxy command, refer to link:https://docs.ansible.com/projects/ansible/latest/cli/ansible-galaxy.html[Ansible Galaxy Documentation^] and for more information about the NetApp Ansible Collection, refer to the link:https://galaxy.ansible.com/netapp/ontap[NetApp Ansible Collection page^].
