...
summary: Provides information on how to execute Ansible Playbook without using the NetApp Docker image.
---
...
[.lead]
This procedure provides information on how to execute Ansible Playbook without using the NetApp Docker image.
