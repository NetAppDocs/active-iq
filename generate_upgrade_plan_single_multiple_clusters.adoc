...
* Ensure that AutoSupport (ASUP) is enabled and configured correctly, and all required sections are included. For more information, see link:hhttps://kb.netapp.com/on-prem/ontap/Ontap_OS/OS-KBs/ONTAP_AutoSupport_Resolution_Guide[ONTAP AutoSupport Resolution Guide].
