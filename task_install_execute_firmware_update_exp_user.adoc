...
----
NOTE: The Ansible Playbook and the inventory file must be in the same path.
...
----
. Execute the Ansible Playbook. Firmware updates run in the background for a few hours.
+
