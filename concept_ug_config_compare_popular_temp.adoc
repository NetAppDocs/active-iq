...
image:config_compare_dashboard[image,width=448,height=240]
...
image:on_demand_config_compare_popular_temp[image,width=448,height=240]
...
image:on_demand_config_compare_popular_temp_result[image,width=448,height=240]
...
image:on_demand_config_compare_system_autosupport[image,width=448,height=240]
