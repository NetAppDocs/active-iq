...
= Key terms and definitions in Digital Advisor
:toclevels: 1
:hardbreaks:
:nofooter:
:icons: font
...
** *Fix It:* Fixes the risks to the system using Active IQ Unified Manager. Select this button to launch Unified Manager and perform the steps to mitigate the risks.
...
* *Planning widget:* Displays information about the storage expansion, software, and hardware that needs to be renewed.
** *Storage Expansion:*  Identifies systems that have exceeded or are nearing 90% capacity and GRID sites that have exceeded or are nearing 70% capacity. You can raise a request to increase the capacity of your storage system.
** *Support Renewals:* Provides information about the software and hardware that has expired or are near expiration in the next 6 months.
...
// 29-JULY-2026 fix typo Unified Manager, remove version qualifier