...
** *Fix It:* Fixes the risks to the system using Active IQ Unified Manager. Click this button to launch Unified Manager and perform the steps to mitigate the risks.
