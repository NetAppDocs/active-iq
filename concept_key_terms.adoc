...
* *Keystone:* Provides information on your billed and consumed storage capacity. You can also view the capacity by which you have exceeded the billed capacity. The information has further been grouped on the basis of the capacity service levels that you have opted for.
