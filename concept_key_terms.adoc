...
+
To access the AutoSupport feature, log in to Active IQ Digital Advisor and search for a cluster or hostname. The AutoSupport option is available on the left pane.
