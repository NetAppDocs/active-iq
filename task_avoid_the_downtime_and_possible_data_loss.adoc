...
. Select *Actions* in the *Availability & Protection* widget.
image:Availability and protection_image 1 downtime and data loss.png[Availability and Protection widget]
+
For the high-impact security risks, follow the recommended action that is to update disk firmware.
+
. Select the *Risk Name* link for viewing risk summary.
image:Risk summary_image 2 downtime and data loss.png[Risk summary]
. Select the *Unique Risks* tab, and then select the link in the *Corrective Action* column.
...
. Select the *Ansible “A”* icon to generate and download the scripts.
